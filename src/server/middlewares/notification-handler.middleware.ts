...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order #12345.create': {
    roles: ['business-owner', 'hr-manager', 'payroll-administrator', 'employee', 'accountant'],
    key: 'order',
    tenantPath: [],
    userPath: [],
  },
  'Employee #67890.create': {
    roles: ['business-owner', 'hr-manager', 'payroll-administrator', 'employee', 'accountant'],
    key: 'employee',
    tenantPath: [],
    userPath: [],
  },
  'Payroll #12345.update': {
    roles: ['business-owner', 'hr-manager', 'payroll-administrator', 'employee', 'accountant'],
    key: 'payroll',
    tenantPath: [],
    userPath: [],
...
const tenantRoles: string[] = ['business-owner', 'hr-manager', 'payroll-administrator', 'employee', 'accountant'];
